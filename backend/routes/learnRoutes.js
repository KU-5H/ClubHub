...
const {test, registerUser, loginUser, logoutUser, getProfile, addAnnouncement, getAnnouncement, newCalenderEvent, getCalenderEvents, deleteEvent, updateEvent, deleteAnnouncement} = require('../controllers/controller')
